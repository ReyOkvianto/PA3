...
/*
    ...
    cout << "Time completed: " << total_time << " sec" << endl;    
...
*/
    ...
    // RequestChannel* More_Channels[nchannels];
    vector <RequestChannel*> More_Channels;
    ...
    for(int i = 0; i < nchannels; i++) {
        if (isnewchan){
            ...
            //More_Channels[i] = chan;
            More_Channels.push_back(chan);            
        ...
        if (!isfiletransfer){   // requesting data msgs
            ...
            FT_time = (end2.tv_sec - start2.tv_sec) * 1e6;
            FT_time = (FT_time + (end2.tv_usec - start2.tv_usec)) * 1e-6;

        }
    }

    if(isfiletransfer){
        cout << "Time completed: " << FT_time << " sec" << endl;        
    }
